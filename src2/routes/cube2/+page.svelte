...
<script>
    ...
    import OLL47 from "$lib/transformations/OLL47.png";
...
var test8 = () => fmoves([
  ...
  // console.log(king.L2st())
    ...
    // var L3a = [(R),(Cxr),(Uz),(R),(Cxr),(R),(Cxr),(U),(R),(Cxr),(R),(Cxr),(U),(R),(Cxr),(R),(Cxr),(Uz),(R),(Cxr)]
     var L3a = [R, Bz, R, R, F, R, R, B, R, R, Fz, R]
...
/*
    ...
    function LL49 () {
        Start();
        fmoves([Tz, U, Tz, Tz, Uz, Tz, Tz, Uz, Tz, Tz, U, Tz, Yro, Yro])
    }

    function LL50 () {
        Start();
        fmoves([T, Uz, Tz, Tz, U, Tz, Tz, U, Tz, Tz, Uz, T])
    }
    ...
    function compare9 () {
        ...
        if (JSON.stringify(a1) == JSON.stringify(b1)) {
            ...
            m(U);
            compare9();F R' F' R U2' F R' F' R U' R U' R'
            nn = 0;
            compare10();
        }
    }
...
<br /><br /> 
        <span>&nbsp;&nbsp;&nbsp;</span> 
        <img src={OLL47} alt="OLL47" style="width:75px;height:76px;" />
        <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> 
        <img src={OLL47} alt="OLL47" style="width:75px;height:76px;" />
        <img src={OLL47} alt="OLL47" style="width:75px;height:76px;" />
<br><br> 
...
<button on:click={queenbar1}>king.bar1</buttonF R' F' R U2' F R' F' R U' R U' R'>
