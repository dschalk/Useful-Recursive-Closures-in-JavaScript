...
<p> Players fail most attempts to double their money. Lacking sufficient funds to cover a losing bet, they leave with whatever they still have. The amount they lose varies, but it's rarely everything they started with. Less frequent doubling of the initial bet compensates for the more frequent, but smaller, losses. After 100,000 attempts to double a starting stake of $50, the percent difference between gains and losses with respect to total gains and losses ((gains - losses)/(gains+losses))*100 %) is usually less than 0,05%. The "gamble" function (below) demonstrate this with ten consecutive runs. </p>
