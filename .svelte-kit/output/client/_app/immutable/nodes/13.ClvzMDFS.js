import{s as p,n as r}from"../chunks/Bv-lJKiI.js";import{S as g,i as m,d as s,a as c,j as x,l as d,c as h,g as b,b as v,k as y,h as w,e as f,f as C,t as F}from"../chunks/D2RDcUeg.js";function E(i){let e,u="Python Recursive Closures",a,t,l;return{c(){e=f("h1"),e.textContent=u,a=C(),t=f("pre"),l=F(i[0]),this.h()},l(n){e=h(n,"H1",{class:!0,"data-svelte-h":!0}),b(e)!=="svelte-tge4o6"&&(e.textContent=u),a=v(n),t=h(n,"PRE",{class:!0});var o=y(t);l=w(o,i[0]),o.forEach(s),this.h()},h(){d(e,"class","svelte-1cqu3wk"),d(t,"class","svelte-1cqu3wk")},m(n,o){c(n,e,o),c(n,a,o),c(n,t,o),x(t,l)},p:r,i:r,o:r,d(n){n&&(s(e),s(a),s(t))}}}function S(i){var e=`
...
`;return[e]}class T extends g{constructor(e){super(),m(this,e,S,E,p,{})}}export{T as component};
